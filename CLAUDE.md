...
- **Scritto ma NON attivo:** il motore 6j non è collegato a nessuna sorgente né scheduler;
  nessuno chiama `AutomationExecutor.onTrigger()`. Le automazioni funzionanti restano quelle
  della fase 6f (Markdown). Il subentro è deliberatamente l'ultimo passo.
